        ...
        public void UpdateView()
        {
            ...
            if (projectionScreen != null && cameraComponent != null)
            {
                ...
                float topEdgeDistance =
                    Vector3.Dot(screenUpAxis, eyeToUpperLeft) * nearClipDistance / eyeToScreenDistance;

                projectionMatrix[0, 0] = 2.0f * nearClipDistance / (rightEdgeDistance - leftEdgeDistance);
                projectionMatrix[0, 1] = 0.0f;
                projectionMatrix[0, 2] =
                    (rightEdgeDistance + leftEdgeDistance) / (rightEdgeDistance - leftEdgeDistance);
                projectionMatrix[0, 3] = 0.0f;

                projectionMatrix[1, 0] = 0.0f;
                projectionMatrix[1, 1] = 2.0f * nearClipDistance / (topEdgeDistance - bottomEdgeDistance);
                projectionMatrix[1, 2] =
                    (topEdgeDistance + bottomEdgeDistance) / (topEdgeDistance - bottomEdgeDistance);
                ...
                projectionMatrix[2, 3] =
                    2.0f * farClipDistance * nearClipDistance / (nearClipDistance - farClipDistance);
